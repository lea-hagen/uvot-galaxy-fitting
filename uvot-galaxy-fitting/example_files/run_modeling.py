...
def run_modeling():
    ...
    filter_list = ['fuv','nuv','w2','m2','w1','u','g','r','i','3.6']
    ...
    # create grids
    create_grids.create_grids(filter_list, filter_transmission_curves, metallicity)

    
    # ---- modeling-related things

    # filters to model
    filter_list = ['fuv','nuv','w2','m2','w1','g','r','i','3.6']
    ...
    for i in range(n_region):
        mags = {f:phot[i] for i,f in enumerate(filter_list)}
        mag_errs = {f:phot_err[i] for i,f in enumerate(filter_list)}
